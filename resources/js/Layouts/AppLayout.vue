                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="flex-shrink-0 flex items-center">
                                <inertia-link :href="route('execution')">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('execution')" :active="route().current('execution')">
                                    Izvajanja
                                </jet-nav-link>
                            </div>
                        </div>
...
<!--                        <jet-responsive-nav-link :href="route('execution')" :active="route().current('execution')">-->
<!--                            Izvajanja-->
